...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-[#050505] selection:bg-accent selection:text-black overflow-hidden">
      ...
      {/* Right side (Desktop): Cinematic Visual */}
      <motion.div 
        initial={{ opacity: 0, x: 100 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 1.5, ease: [0.16, 1, 0.3, 1] }}
        className="hidden lg:block relative p-20 flex flex-col justify-between overflow-hidden order-last"
      >
        <img 
          src="https://images.unsplash.com/photo-1635830383423-2814044938f8?auto=format&fit=crop&q=80&w=1200"
          alt="Abstract Architecture"
          className="absolute inset-0 w-full h-full object-cover grayscale opacity-40 mix-blend-screen"
        />
        <div className="absolute inset-0 bg-gradient-to-bl from-accent/20 via-blue-900/40 to-black z-10" />
        ...
        <div className="relative z-20 flex items-center justify-end gap-3">
          ...
          <span className="text-[10px] font-black tracking-[0.4em] text-gray-500 uppercase">SIGNUP</span>
          <UserPlus className="w-10 h-10 text-accent" />
        </div>

        <div className="relative z-20 space-y-6 text-right">
          <h2 className="text-7xl font-black tracking-tighter text-white leading-[0.85]">Start your <br /> <span className="text-accent">journey.</span></h2>
          <p className="text-gray-400 text-lg font-medium max-w-md ml-auto leading-relaxed">
            Join our platform to access expert engineering courses and earn your certificates.
          </p>
        </div>

        <div className="relative z-20 flex items-center justify-end gap-6">
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-600">Global learning network</p>
      ...
      <section className="relative p-8 md:p-20 flex flex-col justify-center items-center">
        <div className="w-full max-w-md space-y-12">
          <div className="space-y-4 text-center lg:text-left">
            ...
            <h1 className="text-5xl font-black tracking-tighter text-white">Join KodNest</h1>
            <p className="text-gray-500 font-medium">Create your student account to start learning today.</p>
          </div>
            ...
            <div className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <User className="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500 group-focus-within:text-accent transition-colors" />
                  <input
                    type="text"
                    value={name}
          ...
          <div className="pt-8 text-center lg:text-left">
            <p className="text-sm font-medium text-gray-500">
              Already a member?{" "}
              <Link href="/auth/login" className="text-accent hover:text-white transition-colors font-black uppercase tracking-widest italic ml-2">
                Log in
              </Link>
            </p>
          </div>
